				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Manage Views</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Natal Data of Registered Clients"
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>Name</th>
														<th>Date of Birth</th>
														<th class="hidden-480">Time of Birth</th>

														<th>
															<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
															Place of Birth
														</th>
														<th class="hidden-480">Ascendant</th>
														<!--<th class="hidden-480">Moon Star</th>-->
...
$sql = "SELECT id, client_name, client_dob, client_tob, client_pob, client_asc, client_moon, user_id FROM natal_data WHERE user_id = $userID";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    //echo "<br> id: ". $row["id"]. " - Name: ". $row["client_name"]. " " . $row["client_dob"]. $row["client_tob"]. " " . $row["client_pob"]. " " .  "<br>";
...
?>													
													...
													<tr>
														...
														<td class="hidden-480"><?php echo $row["client_tob"]; ?></td>
														<td class="hidden-480"><?php echo $row["client_pob"]; ?></td>

														<td class="hidden-480">
														<?php 
														If ($row["client_asc"] == "Aries" or $row["client_asc"] == "Scorpio")
														{
															echo '<span class="label label-danger arrowed arrowed-right">';
														}
														elseif ($row["client_asc"] == "Taurus" or $row["client_asc"] == "Libra" )
														{
															echo '<span class="label label-info arrowed arrowed-right">';
														}
														elseif ($row["client_asc"] == "Gemini" or $row["client_asc"] == "Virgo")
														{
															echo '<span class="label label-success arrowed arrowed-right">';
														}
														elseif ($row["client_asc"] == "Cancer")
														{
															echo '<span class="label label arrowed arrowed-right">';
														}
														elseif ($row["client_asc"] == "Leo")
															{
															echo '<span class="label label-warning arrowed arrowed-right">';
														}
														elseif ($row["client_asc"] == "Sagittarius" or $row["client_asc"] == "Pisces")
														{
															echo '<span class="label label-purple arrowed arrowed-right">';
														}
														elseif ($row["client_asc"] == "Capricorn" or $row["client_asc"] == "Aquarius")
														{
															echo '<span class="label label-inverse arrowed arrowed-right">';
														}
														?>

															<?php echo $row["client_asc"]; ?></span>
														</td>
														<!--<td><?php echo $row["client_moon"]; ?></td>-->

														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="natal.php?id=<?php echo $row["id"]; ?>">
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		<li>
																			<a href="natal.php?id=<?php echo $row["id"]; ?>" class="tooltip-info" data-rel="tooltip" title="View">
																				<span class="blue">
