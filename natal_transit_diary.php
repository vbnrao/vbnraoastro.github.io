						...
						<div class="row">
                          ...
                          <form action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $_GET['id']; ?>" method="post">	
                            ...
                            <div class="row">
														...
														<input type="text" class="form-control" name="vbnnumberdays" id="vbnnumberdays" placeholder="Number of Days" readonly="true">
														</div>
                          </div>
...
<div align="center"><span class="label label-lg label-pink"><strong>Legend</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-lg label-inverse">Transit Planet in Kakshya</span>&nbsp;&nbsp;<span class="label label-lg label-primary">Samudayaka Ashtakavarga Points in Transit</span>&nbsp;&nbsp;<span class="label label-lg label-success">Good</span>&nbsp;&nbsp;<span class="label label-lg label-warning">Medium</span>&nbsp;&nbsp;<span class="label label-lg label-danger">Bad</span></div>
                    <div class="clearfix">
                      <div class="pull-right tableTools-container"></div>
                    </div>
                    <div class="table-header">
                      Results for "Samudayaka Ashtakavarga Points in Transit" for the period from : <strong><?php echo $txt_trans_day[0] . " for " . $sn_days . " days"; ?></strong>
                    </div>
...
//echo "This is Moon Temp Kakshya : " . $tmp_Kakshya_Sun[$xx] . "<br>";
If ($tmp_Kakshya_Sun[$xx] == "Sun")
{
 $strg_Kakshya_sun[$xx] = $Sun_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Mon")
{
 $strg_Kakshya_sun[$xx] = $Moon_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Mar")
{
 $strg_Kakshya_sun[$xx] = $Mar_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Mer")
{
 $strg_Kakshya_sun[$xx] = $Mer_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Jup")
{
 $strg_Kakshya_sun[$xx] = $Jup_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Ven")
{
 $strg_Kakshya_sun[$xx] = $Ven_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Sat")
{
 $strg_Kakshya_sun[$xx] = $Sat_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sun[$xx] == "Asc")
{
 $strg_Kakshya_sun[$xx] = $Lag_kak_arr[($tmmp_Rasi_Sun[$xx]-1)]; 
}
...
{
 $strg_Kakshya_moon[$xx] = $Sun_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Mon")
{
 $strg_Kakshya_moon[$xx] = $Moon_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Mar")
{
 $strg_Kakshya_moon[$xx] = $Mar_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Mer")
{
 $strg_Kakshya_moon[$xx] = $Mer_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Jup")
{
 $strg_Kakshya_moon[$xx] = $Jup_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Ven")
{
 $strg_Kakshya_moon[$xx] = $Ven_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Sat")
{
 $strg_Kakshya_moon[$xx] = $Sat_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Moon[$xx] == "Asc")
{
 $strg_Kakshya_moon[$xx] = $Lag_kak_arr[($tmmp_Rasi_Moon[$xx]-1)]; 
}
...
{
 $strg_Kakshya_mar[$xx] = $Sun_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Mon")
{
 $strg_Kakshya_mar[$xx] = $Moon_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Mar")
{
 $strg_Kakshya_mar[$xx] = $Mar_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Mer")
{
 $strg_Kakshya_mar[$xx] = $Mer_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Jup")
{
 $strg_Kakshya_mar[$xx] = $Jup_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Ven")
{
 $strg_Kakshya_mar[$xx] = $Ven_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Sat")
{
 $strg_Kakshya_mar[$xx] = $Sat_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mar[$xx] == "Asc")
{
 $strg_Kakshya_mar[$xx] = $Lag_kak_arr[($tmmp_Rasi_Mar[$xx]-1)]; 
}
...
{
 $strg_Kakshya_mer[$xx] = $Sun_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Mon")
{
 $strg_Kakshya_mer[$xx] = $Moon_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Mar")
{
 $strg_Kakshya_mer[$xx] = $Mar_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Mer")
{
 $strg_Kakshya_mer[$xx] = $Mer_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Jup")
{
 $strg_Kakshya_mer[$xx] = $Jup_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Ven")
{
 $strg_Kakshya_mer[$xx] = $Ven_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Sat")
{
 $strg_Kakshya_mer[$xx] = $Sat_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Mer[$xx] == "Asc")
{
 $strg_Kakshya_mer[$xx] = $Lag_kak_arr[($tmmp_Rasi_Mer[$xx]-1)]; 
}
...
{
 $strg_Kakshya_jup[$xx] = $Sun_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Mon")
{
 $strg_Kakshya_jup[$xx] = $Moon_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Mar")
{
 $strg_Kakshya_jup[$xx] = $Mar_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Mer")
{
 $strg_Kakshya_jup[$xx] = $Mer_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Jup")
{
 $strg_Kakshya_jup[$xx] = $Jup_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Ven")
{
 $strg_Kakshya_jup[$xx] = $Ven_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Sat")
{
 $strg_Kakshya_jup[$xx] = $Sat_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Jup[$xx] == "Asc")
{
 $strg_Kakshya_jup[$xx] = $Lag_kak_arr[($tmmp_Rasi_Jup[$xx]-1)]; 
}
...
{
 $strg_Kakshya_ven[$xx] = $Sun_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Mon")
{
 $strg_Kakshya_ven[$xx] = $Moon_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Mar")
{
 $strg_Kakshya_ven[$xx] = $Mar_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Mer")
{
 $strg_Kakshya_ven[$xx] = $Mer_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Jup")
{
 $strg_Kakshya_ven[$xx] = $Jup_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Ven")
{
 $strg_Kakshya_ven[$xx] = $Ven_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Sat")
{
 $strg_Kakshya_ven[$xx] = $Sat_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ven[$xx] == "Asc")
{
 $strg_Kakshya_ven[$xx] = $Lag_kak_arr[($tmmp_Rasi_Ven[$xx]-1)]; 
}
...
{
 $strg_Kakshya_sat[$xx] = $Sun_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Mon")
{
 $strg_Kakshya_sat[$xx] = $Moon_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Mar")
{
 $strg_Kakshya_sat[$xx] = $Mar_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Mer")
{
 $strg_Kakshya_sat[$xx] = $Mer_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Jup")
{
 $strg_Kakshya_sat[$xx] = $Jup_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Ven")
{
 $strg_Kakshya_sat[$xx] = $Ven_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Sat")
{
 $strg_Kakshya_sat[$xx] = $Sat_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Sat[$xx] == "Asc")
{
 $strg_Kakshya_sat[$xx] = $Lag_kak_arr[($tmmp_Rasi_Sat[$xx]-1)]; 
}
...
{
 $strg_Kakshya_rah[$xx] = $Sun_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Mon")
{
 $strg_Kakshya_rah[$xx] = $Moon_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Mar")
{
 $strg_Kakshya_rah[$xx] = $Mar_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Mer")
{
 $strg_Kakshya_rah[$xx] = $Mer_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Jup")
{
 $strg_Kakshya_rah[$xx] = $Jup_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Ven")
{
 $strg_Kakshya_rah[$xx] = $Ven_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Sat")
{
 $strg_Kakshya_rah[$xx] = $Sat_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Rah[$xx] == "Asc")
{
 $strg_Kakshya_rah[$xx] = $Lag_kak_arr[($tmmp_Rasi_Rah[$xx]-1)]; 
}
...
{
 $strg_Kakshya_ket[$xx] = $Sun_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Mon")
{
 $strg_Kakshya_ket[$xx] = $Moon_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Mar")
{
 $strg_Kakshya_ket[$xx] = $Mar_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Mer")
{
 $strg_Kakshya_ket[$xx] = $Mer_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Jup")
{
 $strg_Kakshya_ket[$xx] = $Jup_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Ven")
{
 $strg_Kakshya_ket[$xx] = $Ven_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Sat")
{
 $strg_Kakshya_ket[$xx] = $Sat_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
elseif ($tmp_Kakshya_Ket[$xx] == "Asc")
{
 $strg_Kakshya_ket[$xx] = $Lag_kak_arr[($tmmp_Rasi_Ket[$xx]-1)]; 
}
...
?>
                          <tr>
                            ...
                            <td align="center">
                              ...
                              <a href="#modal-table<?php echo $xx; ?>" role="button" class="green" data-toggle="modal"><?php echo $txt_trans_day[$xx]; ?></a>
...
//**************************************************
                            ...
                            <td class="hidden-480"><?php echo round($tmp_Long_Sun[$xx],2) . "~". $tmp_Kakshya_Sun[$xx] . "~" . $strg_Kakshya_sun[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Moon[$xx],2) . "~". $tmp_Kakshya_Moon[$xx] . "~" . $strg_Kakshya_moon[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Jup[$xx],2) . "~". $tmp_Kakshya_Jup[$xx] . "~" . $strg_Kakshya_jup[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Mar[$xx],2) . "~". $tmp_Kakshya_Mar[$xx] . "~" . $strg_Kakshya_mar[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Ven[$xx],2) . "~". $tmp_Kakshya_Ven[$xx] . "~" . $strg_Kakshya_ven[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Mer[$xx],2) . "~". $tmp_Kakshya_Mer[$xx] . "~" . $strg_Kakshya_mer[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Sat[$xx],2) . "~". $tmp_Kakshya_Sat[$xx] . "~" . $strg_Kakshya_sat[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Rah[$xx],2) . "~". $tmp_Kakshya_Rah[$xx] . "~" . $strg_Kakshya_rah[$xx]; ?></td>
                            <td class="hidden-480"><?php echo round($tmp_Long_Ket[$xx],2) . "~". $tmp_Kakshya_Ket[$xx] . "~" . $strg_Kakshya_ket[$xx]; ?></td>
...
<!-->
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Sun[$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_sun[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Moon [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_moon[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Jup   [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_jup[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Mar  [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_mar[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Ven    [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_ven[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Mer     [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_mer[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Sat      [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_sat[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Rah      [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_rah[$xx] . '</span>'; ?></td>
                            <td align="center" class="hidden-480"><?php echo '<span class="label label-sm label-inverse">' . $tmp_Kakshya_Ket      [$xx] . '</span>' . "~" . '<span class="label label-sm label-primary">' . $strg_Kakshya_ket[$xx] . '</span>'; ?></td>

                            <td align="center" class="hidden-480">
                              <?php
                              If ($str_Kakshya_sun >=32)
                              {
                                echo '<span class="label label-sm label-success">' . $str_Kakshya_sun . '</span>';
                              }
                              elseif ($str_Kakshya_sun >= 25 and $str_Kakshya_sun < 32)
                              {
                                echo '<span class="label label-sm label-warning">' . $str_Kakshya_sun . '</span>';
                              }
                              else
                              {
                                echo '<span class="label label-sm label-danger">' . $str_Kakshya_sun . '</span>';
                              } 
...
?>
                ...
                <?php echo '<div id="modal-table' . $xx . '"' . 'class="modal fade" tabindex="-1">'; ?>
...
echo "This is Modal Table";
echo "<?php echo modal-table . $xx  ?>";
?>
