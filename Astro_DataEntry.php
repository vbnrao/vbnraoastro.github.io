									...
									<div class="col-sm-5">
										<div class="widget-box">
											<div class="widget-header widget-header-small">
												<h5 class="widget-title lighter"><strong>Natal Data Entry</strong></h5>
											</div>
												...
												<!--	<form action="natal.php" method="post" role="form">  -->
													<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">																
														<div>
															...
															<label for="client_name">
																...
																<input class="input-xxlarge" type="text" id="client_name" name="client_name"  placeholder="Enter Name" value="<?php echo $client_name; ?>">
														...
														<div>
															<div class="form-group <?php echo (!empty($client_dob_err)) ? 'has-error' : ''; ?>">
															<label for="dob">
																Date of Birth
															</label>

															<div class="input-group">
																<input class="form-control date-picker" id="client_dob" name="client_dob" type="text" placeholder="Select Date of Birth" data-date-format="dd.mm.yyyy" value="<?php echo $client_dob; ?>">
																<span class="input-group-addon">
																	<i class="fa fa-calendar bigger-110"></i>
																</span>
																</div>
																<span class="help-block"><?php echo $client_dob_err; ?></span>
															</div>
														<div class="space space-8"></div>

														<div>
															<div class="form-group <?php echo (!empty($client_tob_err)) ? 'has-error' : ''; ?>">
															<label for="client_tob">
																Time of Birth
															</label>
															<div class="input-group bootstrap-timepicker">
															<input class="form-control time-picker" id="client_tob" name="client_tob" type="text" placeholder="Select Time of Birth" data-time-format="hh:mm" value="<?php echo $client_tob; ?>">
															<span class="input-group-addon">
																<i class="fa fa-clock-o bigger-110"></i>
															</span>
														</div>
														<span class="help-block"><?php echo $client_tob_err; ?></span>
														</div>
...
-->
	    ...
	    <div id="showCountry">
	        ...
	        <select class="chosen-select form-control" name="country" id="country" data-placeholder="Choose a Country..." value="<?php echo $country; ?>"  />
	        	<option></option>
	        <?php
				require_once('DbConnection.php');
				$countries=mysqli_query($connection,"SELECT * FROM country ORDER BY country_name");
...
<div class="space space-8"></div>
	    ...
	    <div id="showRegion">
	        ...
	        <select class="chosen-select form-control" name="region" id="region" data-placeholder="Choose a State..." value="<?php echo $region; ?>">
	        	<option></option>
	        </select>
	        <br>
...
<div class="space space-8"></div>
	    ...
	    <div id="showCity">
	        ...
	        <select class="chosen-select form-control" name="city" id="city" data-placeholder="Choose a City..." value="<?php echo $city; ?>">
	        <option></option>
	        </select>
...
<div class="space space-4"></div>
															...
															<div>
																<label class="middle">
																	<input class="ace ace-checkbox-2" type="checkbox" id="chk1" name="chk1"/>
																	<span class="lbl"> Enter Details Manually !</span>
																</label>
																<div class="space space-4"></div>

																<div id="showLatLong" hidden="true">

																<label for="POB">
																Place of Birth
																</label>

																<input class="input-xxlarge" type="text" id="POB" name="POB" value="This text field is disabled!" disabled />
																
															<div class="space space-4"></div>
																	

																<label for="LatDegree">
																Latitude (the format here is like 42 N 1 - don't change the order)
																</label>

																<input class="input-xxlarge" type="text" id="LatDegree" name="LatDegree" value="This text field is disabled!" disabled />
															...
															<label for="LongDegree">
																Longitude (the format here is like 88 W 37 - don't change the order)
															</label>

															<input class="input-xxlarge" type="text" id="LongDegree" name="LongDegree" value="This text field is disabled!" disabled />
															...
															<label for="TZ">
																...
																<input class="input-xxlarge" type="text" id="TimeZone" name="TimeZone" value="This text field is disabled!" disabled " />
									...
									<!-- Form submit Button starts here -->
									<div class="form-group center">
										<input type="submit" id="submit" name="Submit" value="Submit" class="width-5 pull-center btn btn-sm btn-primary"> 
									</div>
								</form>
							</div>
						</div>
